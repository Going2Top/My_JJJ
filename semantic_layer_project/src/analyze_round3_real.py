...
def main():
    print("=" * 60)
    print("第三轮分析：使用扩展的v2代码")
    print("=" * 60)

    files = [
        ("F:/12306/services/ticket-service/src/main/java/org/opengoofy/index12306/biz/ticketservice/controller/TicketController.java", "Controller"),
        ("F:/12306/services/ticket-service/src/main/java/org/opengoofy/index12306/biz/ticketservice/service/TicketService.java", "Service"),
        ("F:/12306/services/ticket-service/src/main/java/org/opengoofy/index12306/biz/ticketservice/toolkit/DateUtil.java", "Util")
    ]

    timestamp = datetime.now().strftime('%Y%m%d_%H%M%S')
    output_dir = Path(f"F:/semantic_layer_project/output/round3_{timestamp}")
