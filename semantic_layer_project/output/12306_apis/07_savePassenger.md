# API Semantic Layer - savePassenger
...
- Responsibility: Update existing records for 乘车人控制层
...
**Entry Point:**
- Method: `PassengerController.savePassenger()`
- HTTP: `POST /api/user-service/passenger/save`
...
Use this API when you need to 乘车人控制层. This operation modifies data.
